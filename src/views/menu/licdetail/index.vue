  ...
  <div class="container">
    <div class="manage-title">
      ...
      <el-form :inline="true">
        ...
        <el-form-item label="持证主体" v-if="labelName === '人员名称'">
          <el-select v-model="treeLabel" @change="change">
            <el-option
        ...
        <el-form-item label="持证主体" v-else prop="certificateHolderCode">
          <treeselect
    ...
    <div class="manage-main">
      ...
      <div class="normal">
        <div style="flex: 6;display: flex">
          ...
          <div class="right-col">
            <p>
              <span>{{
                infoData.certificateName ? infoData.certificateName : "-"
              }}</span>
              <!--                <span v-else>-->
            ...
            <p>
              <span>{{
                infoData.certificateNumber ? infoData.certificateNumber : "-"
              }}</span>
              <!--                <span v-else>-->
        ...
        <div style="flex: 4;display: flex">
          ...
          <div class="right-col" style="flex:6; text-align: left">
            <p>
              <span>{{
                infoData.certificateHolderName
                  ? infoData.certificateHolderName
                  : "-"
              }}</span>
              <!--                <span v-else>-->
            ...
            <p>
              <span>{{
                infoData.certificateTypeCode
                  ? typeMatter(infoData.certificateTypeCode)
                  : "-"
              }}</span>
              <!--                <span v-else>-->
      ...
      <el-form :inline="true" :model="infoData" ref="detailData">
        <div class="detail1">
          <div style="flex: 6;display: flex">
            <div class="left-col">
              <p
            ...
            <div class="right-col">
              ...
              <p>
                <span v-if="!isEdit">{{
                  infoData.certificateSign ? infoData.certificateSign : "-"
                }}</span>
              ...
              <p>
                <span v-if="!isEdit">{{
                  infoData.certificateIssuingAuthorityName
                    ? infoData.certificateIssuingAuthorityName
                    : "-"
                }}</span>
                <el-input
                  v-else
                  v-model="infoData.certificateIssuingAuthorityName"
                />
              </p>
              <!--证照颁发机构统一社会信用代码 certificateIssuingAuthorityCode -->
              <p>
                <span v-if="!isEdit">{{
                  infoData.certificateIssuingAuthorityCode
                    ? infoData.certificateIssuingAuthorityCode
                    : "-"
                }}</span>
                <el-input
                  v-else
                  v-model="infoData.certificateIssuingAuthorityCode"
                />
              </p>
            </div>
          </div>
          <div style="flex: 4;display: flex">
            ...
            <div class="right-col" style="flex:6; text-align: left">
              ...
              <p>
                <span v-if="!isEdit">{{
                  infoData.certificateIssuedDate
                    ? infoData.certificateIssuedDate
                    : "-"
                }}</span>
                <el-date-picker
              ...
              <p>
                <span v-if="!isEdit">{{
                  infoData.certificateEffectiveDate
                    ? infoData.certificateEffectiveDate
                    : "-"
                }}</span>
                <el-date-picker
              ...
              <p>
                <span v-if="!isEdit">{{
                  infoData.certificateExpiringDate
                    ? infoData.certificateExpiringDate
                    : "-"
                }}</span>
                <el-date-picker
...
export default {
  ...
  methods: {
    ...
    saveData() {
      ...
      formData.append(
        "certificateIssuingAuthorityName",
        this.infoData.certificateIssuingAuthorityName
      );
      formData.append(
        "certificateIssuingAuthorityCode",
        this.infoData.certificateIssuingAuthorityCode
      );
      formData.append(
        "certificateIssuedDate",
        this.infoData.certificateIssuedDate
      );
      formData.append(
        "certificateHolderCode",
        this.infoData.certificateHolderCode
      );
      formData.append(
        "certificateEffectiveDate",
        this.infoData.certificateEffectiveDate
      );
      formData.append(
        "certificateExpiringDate",
        this.infoData.certificateExpiringDate
      );
    ...
    async search() {
      this.isEdit = false;
      const data = await api.certificate.getByHolderCode(
  ...
  watch: {
    ...
    labelName() {
      ...
      this.$nextTick(() => {
        if (document.getElementsByClassName("vue-treeselect__single-value")[0])
          return;
